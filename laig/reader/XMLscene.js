...
XMLscene.prototype.init = function (application) {
    ...
    this.versus = [true, false, false];
    this.optionsvalues = [false, false, false];
...
XMLscene.prototype.initLights = function () {
     ...
     if(this.interface.lights["__controllers"].length == 0 ) {
                ...
                if (obj) {
                    ...
                    if (this.versus[0]) {
                        if (this.state == 0) {
                            ...
                            this.state = 0;
                            this.somaTotal += 1;
                            if (this.somaTotal == 25) {
                                this.interface.addGameScore(this.scorep1, this.scorep2);
                            }
                            if (this.player == 1) {
                        ...
                        if(this.interface.undo["__controllers"].length == 0 ) {
                            this.interface.closeOptions();
                        }
                    }
                }
            }
...
XMLscene.prototype.initScenarios = function () {
    ...
    this.scenarioNames = ['Piscina', 'Praia'];
